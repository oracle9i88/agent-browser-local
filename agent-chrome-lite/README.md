...
## Genspark 三路径试探（2026-09-13，Macian 未交付）
...
- 第三条兜底路径已验证：在已登录的日常 Chrome 中，从 Genspark「最近」打开一张已有作品，点击图片进入预览，再点「下载图像」；本机 Downloads 出现已完成的 PNG（768×1376、680132 字节）。本次未触发生成动作；这个结果只证明 Chrome 人工/浏览器操作路径可用，**不是** Macian Agent 下载功能。
